...
module.exports = {
  ...
  forChromiumTest : {
    ...common,
    format : ['progress-bar',`json:${process.env.report_path}chromium-cucumber-report.json`],
    worldParameters: { browser: 'chromium' } 
  },
  forFirefoxTest : {
    ...common,
    format : ['progress-bar',`json:${process.env.report_path}firefox-cucumber-report.json`],
    worldParameters: { browser: 'firefox' } 
  },
  forwebkitTest : {
    ...common,
    format : ['progress-bar',`json:${process.env.report_path}webkit-cucumber-report.json`],
